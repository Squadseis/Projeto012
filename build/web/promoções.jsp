<%-- 
    Document   : promoções
    Created on : 9 de fev. de 2024, 17:22:52
    Author     : nalis
--%>
...
<h1>Confira aqui todas as nossas promoções </h1>
         ...
         <div class="col">
             <div class="produto card h-auto d-flex flex-column">
                 ...
                 <div class="produto-info card-body">
                     ...
                     <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 05,00</p>
         ...
         <div class="col">
             <div class="produto h-auto card d-flex flex-column">
                 ...
                 <div class="produto-info card-body">
                     ...
                     <p></p>
                     <p class="card-text produto-descricao mb-lg-3"> Em 6x de R$ 20 sem juros</p>
                     <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 10,00</p>
                     <p class="card-text text-danger text-lg-end">frete gratis</p>
                 </div>
             </div>
         </div>
         ...
         <div class="col">
             <div class="produto card h-auto d-flex flex-column">
                 ...
                 <div class="produto-info card-body">
                     ...
                     <p class="card-text produto-descricao mb-lg-3"> Em 6x de R$ 20 sem juros</p>
                     <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 15,00</p>
                     <p class="card-text text-danger text-lg-end">frete gratis</p>
                 </div>
             </div>
         </div>
         ...
         <div class="col">
             <div class="produto card h-auto d-flex flex-column">
                 ...
                 <div class="produto-info card-body">
                     <h6 class="card-title text-center">Pulseira</h6>
                     <p class="card-text produto-descricao mb-lg-3"> Em 6x de R$ 20 sem juros</p>
                     <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 25,00</p>
                     <p class="card-text text-danger text-lg-end">frete gratis</p>
                 </div>
             </div>
         </div>
            ...
            <div class="col">
                <div class="produto card h-auto d-flex flex-column">
                    ...
                    <div class="produto-info card-body">
                        <h6 class="card-title text-center">Peixe de madeira</h6>
                        <p class="card-text produto-descricao mb-lg-3"> Em 6x de R$ 20 sem juros</p>
                        <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 11,00</p>
                        <p class="card-text text-danger text-lg-end">frete gratis</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="produto card h-auto d-flex flex-column">
                    ...
                    <div class="produto-info card-body">
                        <h6 class="card-title text-center">Pulseira</h6>
                        <p class="card-text produto-descricao mb-lg-3"> Em 6x de R$ 20 sem juros</p>
                        <p class="card-text text-danger produto-preco"><s style="font-size: 15px;"></s>R$ 1,00</p>
                        <p class="card-text text-danger text-lg-end">frete gratis</p>
                    </div>
                </div>
            </div>
